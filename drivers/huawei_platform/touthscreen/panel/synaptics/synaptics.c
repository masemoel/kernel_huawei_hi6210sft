...
static int synaptics_init_chip(void)
{
	...
	for (count = 0; synaptics_sett_param_regs_map[count].module_name  != NULL; count++)
	{
		...
		break;
		/* BEGIN PN:DTS2014092900595,Modified by l00216194, 2014/09/29*/
		...
		case SYNAPTICS_S3320:
			...
			goto out;
		break;
		/* END PN:DTS2014092900595,Modified by l00216194, 2014/09/29*/
...
static int synaptics_set_holster_switch(u8 holster_switch)
{
	...
	/* BEGIN PN:DTS2014102100380, Added by c00299109, 2014/10/27*/
	u8 force_cal = 0;
	/* END   PN:DTS2014102100380, Added by c00299109, 2014/10/27*/
	u8 temp_value;
	...
	{
	case SYNAPTICS_S3207:
		/* BEGIN PN:DTS2014091007771,Added by l00216194, 2014/9/30*/
		...
		/* END   PN: DTS2014091007771,Added by l00216194, 2014/9/30*/
...
static int synaptics_before_suspend(void)
{
...
#ifdef GLOVE_SIGNAL
	/* BEGIN PN: DTS2014091007771,Modified by l00216194, 2014/9/30*/
	if (SYNAPTICS_S3207 != rmi4_data->synaptics_chip_data->ic_type){
	...
	/* END   PN: DTS2014091007771,Modified by l00216194, 2014/9/30*/
#endif
	TS_LOG_INFO("before_suspend -\n");
	return retval;
}
	...
	if (!list_empty(&rmi->support_fn_list)) {
		list_for_each_entry_safe(fhandler, fhandler_temp, &rmi->support_fn_list, link) {
			...
			if (fhandler->fn_number == SYNAPTICS_RMI4_F1A) {
                ...
                /* DTS2014102502433 y00178174 201401025 begin */
                if (fhandler->extra) {
                    kfree(fhandler->extra);
                    fhandler->extra = NULL;
                }
                /* DTS2014102502433 y00178174 201401025 end >*/
			}
			kfree(fhandler);
			fhandler = NULL;
		}
...
{
	int retval = 0;
	/* BEGIN PN:DTS2014092900595,Added by l00216194, 2014/09/29*/
	int count = 11;
	/* END   PN: DTS2014092900595,Added by l00216194, 2014/09/29*/
